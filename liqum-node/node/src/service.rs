...
use liqum_node_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
    pub Executor,
    liqum_node_runtime::api::dispatch,
    liqum_node_runtime::native_version,
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = sc_service::ServiceBuilder::new_full::<
            liqum_node_runtime::opaque::Block,
            liqum_node_runtime::RuntimeApi,
